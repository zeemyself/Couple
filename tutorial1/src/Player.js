var Player = cc.Sprite.extend({
	...
	isPossibleToMove : function( dir){
		...
		switch ( dir ) {
        case Player.DIR.UP:
        	this.nextBlockX = this.X;
            this.nextBlockY = this.Y + Player.MOVE_STEP;
            break;
        case Player.DIR.DOWN:
       	    this.nextBlockX = this.X;
            this.nextBlockY = this.Y - Player.MOVE_STEP;
            break;
        case Player.DIR.LEFT:
            this.nextBlockX =  this.X - Player.MOVE_STEP;
            this.nextBlockY = this.Y;
            break;
        case Player.DIR.RIGHT:
            this.nextBlockX = this.X + Player.MOVE_STEP;
            this.nextBlockY = this.Y;
         ...
         return true;
        this.nextBlockX = (this.nextBlockX - 20) / 40;
		this.nextBlockY = (this.nextBlockY - 20) / 40;
        console.log("X:" + this.nextBlockX);
		console.log("Y:" + this.nextBlockY);
